...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { url, is_coming_soon, is_for_sale, sale_price, sale_condition, is_expansion, parent_game_id, location_room, location_shelf, purchase_price, purchase_date, sleeved, upgraded_components } = await req.json();
